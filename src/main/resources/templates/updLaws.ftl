...
<div class="overall">
    ...
    <footer>
        ...
        <div>
            <form action="updLawAction" method="post" enctype="multipart/form-data">
            <table class="biaodan" cellspacing="10px">
                <tr>
                    <td>法规号别名:</td>
                    <td><h3>${lawInfo.lawAlias}</h3><input style="display: none;" class="layui-input x-input" type="text" name="lawAlias" value="${lawInfo.lawAlias}"></td>
                </tr>
                <tr>
